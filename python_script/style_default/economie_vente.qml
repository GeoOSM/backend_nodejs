...
<qgis simplifyDrawingHints="0" styleCategories="AllStyleCategories" simplifyMaxScale="1" maxScale="0" labelsEnabled="0" simplifyLocal="1" version="3.4.7-Madeira" minScale="1e+08" simplifyDrawingTol="1" simplifyAlgorithm="0" readOnly="0" hasScaleBasedVisibilityFlag="0">
  <flags>
    <Identifiable>1</Identifiable>
    <Removable>1</Removable>
    <Searchable>1</Searchable>
  </flags>
  <renderer-v2 type="pointCluster" tolerance="20" enableorderby="0" toleranceUnit="MM" toleranceUnitScale="3x:0,0,0,0,0,0" forceraster="0">
      ...
      <symbols>
        <symbol type="marker" force_rhr="0" name="0" alpha="1" clip_to_extent="1">
          <layer locked="0" class="SvgMarker" enabled="1" pass="0">
            ...
            <prop k="name" v="/var/www/smartworld/occitanie_gpkg/img/Boutique_de_v_tements.svg"/>
            <prop k="offset" v="0,0"/>
  ...
  <SingleCategoryDiagramRenderer diagramType="Histogram" attributeLegend="1">
    <DiagramCategory penWidth="0" diagramOrientation="Up" backgroundAlpha="255" opacity="1" sizeType="MM" barWidth="5" height="15" enabled="0" width="15" lineSizeType="MM" labelPlacementMethod="XHeight" sizeScale="3x:0,0,0,0,0,0" backgroundColor="#ffffff" scaleBasedVisibility="0" scaleDependency="Area" minimumSize="0" penColor="#000000" lineSizeScale="3x:0,0,0,0,0,0" penAlpha="255" minScaleDenominator="0" rotationOffset="270" maxScaleDenominator="1e+08">
      <fontProperties style="" description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0"/>
      <attribute color="#000000" label="" field=""/>
    </DiagramCategory>
  </SingleCategoryDiagramRenderer>
  <DiagramLayerSettings placement="0" zIndex="0" linePlacementFlags="18" dist="0" priority="0" showAll="1" obstacle="0">
    <properties>
      <Option type="Map">
        <Option type="QString" name="name" value=""/>
        <Option name="properties"/>
