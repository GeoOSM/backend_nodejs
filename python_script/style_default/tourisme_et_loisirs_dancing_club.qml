...
<qgis styleCategories="AllStyleCategories" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyDrawingHints="0" simplifyLocal="1" labelsEnabled="0" simplifyAlgorithm="0" readOnly="0" minScale="1e+08" maxScale="0" version="3.4.7-Madeira" simplifyDrawingTol="1">
  <flags>
    <Identifiable>1</Identifiable>
    <Removable>1</Removable>
    <Searchable>1</Searchable>
  </flags>
  <renderer-v2 forceraster="0" type="pointCluster" toleranceUnit="MM" toleranceUnitScale="3x:0,0,0,0,0,0" tolerance="20" enableorderby="0">
      ...
      <symbols>
        <symbol name="0" force_rhr="0" type="marker" alpha="1" clip_to_extent="1">
          <layer class="SvgMarker" enabled="1" locked="0" pass="0">
            ...
            <prop k="name" v="/var/www/smartworld/occitanie_gpkg/img/Sauna.svg"/>
            <prop k="offset" v="0,0"/>
  ...
  <SingleCategoryDiagramRenderer attributeLegend="1" diagramType="Histogram">
    <DiagramCategory backgroundAlpha="255" scaleDependency="Area" backgroundColor="#ffffff" penAlpha="255" penColor="#000000" sizeScale="3x:0,0,0,0,0,0" lineSizeScale="3x:0,0,0,0,0,0" opacity="1" scaleBasedVisibility="0" sizeType="MM" diagramOrientation="Up" labelPlacementMethod="XHeight" barWidth="5" enabled="0" rotationOffset="270" width="15" height="15" minimumSize="0" penWidth="0" maxScaleDenominator="1e+08" lineSizeType="MM" minScaleDenominator="0">
