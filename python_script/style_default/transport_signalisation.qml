...
<qgis simplifyDrawingHints="0" simplifyAlgorithm="0" maxScale="0" hasScaleBasedVisibilityFlag="0" labelsEnabled="0" minScale="1e+08" styleCategories="AllStyleCategories" simplifyDrawingTol="1" version="3.4.7-Madeira" readOnly="0" simplifyLocal="1" simplifyMaxScale="1">
  <flags>
      ...
      <symbols>
        <symbol name="0" clip_to_extent="1" type="marker" alpha="1" force_rhr="0">
          <layer class="SvgMarker" enabled="1" pass="0" locked="0">
            ...
            <prop k="name" v="/var/www/smartworld/occitanie_gpkg/img/Signalisation_horizontale.svg"/>
            <prop k="offset" v="0,0"/>
  ...
  <SingleCategoryDiagramRenderer diagramType="Histogram" attributeLegend="1">
    <DiagramCategory diagramOrientation="Up" width="15" sizeScale="3x:0,0,0,0,0,0" backgroundAlpha="255" minScaleDenominator="0" height="15" scaleDependency="Area" penAlpha="255" penColor="#000000" barWidth="5" rotationOffset="270" opacity="1" enabled="0" labelPlacementMethod="XHeight" penWidth="0" backgroundColor="#ffffff" scaleBasedVisibility="0" lineSizeType="MM" sizeType="MM" maxScaleDenominator="1e+08" lineSizeScale="3x:0,0,0,0,0,0" minimumSize="0">
      <fontProperties description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0" style=""/>
      <attribute color="#000000" label="" field=""/>
    </DiagramCategory>
  </SingleCategoryDiagramRenderer>
  <DiagramLayerSettings linePlacementFlags="18" showAll="1" placement="0" priority="0" zIndex="0" dist="0" obstacle="0">
    <properties>
      <Option type="Map">
        <Option value="" name="name" type="QString"/>
        <Option name="properties"/>
