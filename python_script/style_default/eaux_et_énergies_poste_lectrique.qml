...
<qgis simplifyLocal="1" hasScaleBasedVisibilityFlag="0" minScale="1e+08" simplifyMaxScale="1" styleCategories="AllStyleCategories" readOnly="0" simplifyAlgorithm="0" version="3.4.7-Madeira" simplifyDrawingTol="1" simplifyDrawingHints="0" maxScale="0" labelsEnabled="0">
  <flags>
    <Identifiable>1</Identifiable>
    <Removable>1</Removable>
    <Searchable>1</Searchable>
  </flags>
  <renderer-v2 toleranceUnitScale="3x:0,0,0,0,0,0" enableorderby="0" forceraster="0" tolerance="20" toleranceUnit="MM" type="pointCluster">
      ...
      <symbols>
        <symbol alpha="1" clip_to_extent="1" force_rhr="0" name="0" type="marker">
          <layer locked="0" class="SvgMarker" enabled="1" pass="0">
            ...
            <prop v="/var/www/smartworld/occitanie_gpkg/img/Poste__lectrique.svg" k="name"/>
            <prop v="0,0" k="offset"/>
  ...
  <SingleCategoryDiagramRenderer diagramType="Histogram" attributeLegend="1">
    <DiagramCategory maxScaleDenominator="1e+08" scaleBasedVisibility="0" penAlpha="255" minimumSize="0" penWidth="0" barWidth="5" height="15" sizeType="MM" rotationOffset="270" opacity="1" minScaleDenominator="0" penColor="#000000" backgroundColor="#ffffff" enabled="0" sizeScale="3x:0,0,0,0,0,0" lineSizeScale="3x:0,0,0,0,0,0" scaleDependency="Area" backgroundAlpha="255" labelPlacementMethod="XHeight" lineSizeType="MM" diagramOrientation="Up" width="15">
      <fontProperties style="" description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0"/>
      <attribute label="" field="" color="#000000"/>
    </DiagramCategory>
  </SingleCategoryDiagramRenderer>
  <DiagramLayerSettings zIndex="0" priority="0" linePlacementFlags="18" placement="0" obstacle="0" dist="0" showAll="1">
    <properties>
      <Option type="Map">
        <Option value="" name="name" type="QString"/>
        <Option name="properties"/>
