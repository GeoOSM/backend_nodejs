...
<qgis simplifyLocal="1" simplifyMaxScale="1" labelsEnabled="0" simplifyDrawingHints="0" simplifyDrawingTol="1" styleCategories="AllStyleCategories" simplifyAlgorithm="0" maxScale="0" version="3.4.7-Madeira" readOnly="0" minScale="1e+08" hasScaleBasedVisibilityFlag="0">
  <flags>
      ...
      <symbols>
        <symbol clip_to_extent="1" force_rhr="0" name="0" alpha="1" type="marker">
          <layer enabled="1" locked="0" pass="0" class="SvgMarker">
            ...
            <prop k="name" v="/var/www/smartworld/occitanie_gpkg/img/Parc_aquatique.svg"/>
            <prop k="offset" v="0,0"/>
  ...
  <SingleCategoryDiagramRenderer diagramType="Histogram" attributeLegend="1">
    <DiagramCategory labelPlacementMethod="XHeight" penAlpha="255" barWidth="5" rotationOffset="270" backgroundColor="#ffffff" diagramOrientation="Up" backgroundAlpha="255" maxScaleDenominator="1e+08" scaleDependency="Area" minScaleDenominator="0" minimumSize="0" lineSizeScale="3x:0,0,0,0,0,0" penColor="#000000" sizeType="MM" enabled="0" sizeScale="3x:0,0,0,0,0,0" height="15" penWidth="0" lineSizeType="MM" opacity="1" scaleBasedVisibility="0" width="15">
      <fontProperties description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0" style=""/>
      <attribute color="#000000" field="" label=""/>
    </DiagramCategory>
  </SingleCategoryDiagramRenderer>
  <DiagramLayerSettings dist="0" placement="0" linePlacementFlags="18" obstacle="0" zIndex="0" showAll="1" priority="0">
    <properties>
      <Option type="Map">
        <Option name="name" value="" type="QString"/>
        <Option name="properties"/>
