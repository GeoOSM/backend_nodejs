...
<qgis version="3.4.7-Madeira" simplifyDrawingTol="1" simplifyMaxScale="1" readOnly="0" labelsEnabled="0" styleCategories="AllStyleCategories" simplifyLocal="1" simplifyDrawingHints="0" hasScaleBasedVisibilityFlag="0" maxScale="0" minScale="1e+08" simplifyAlgorithm="0">
  <flags>
    <Identifiable>1</Identifiable>
    <Removable>1</Removable>
    <Searchable>1</Searchable>
  </flags>
  <renderer-v2 forceraster="0" tolerance="20" type="pointCluster" toleranceUnitScale="3x:0,0,0,0,0,0" toleranceUnit="MM" enableorderby="0">
      ...
      <symbols>
        <symbol clip_to_extent="1" alpha="1" type="marker" name="0" force_rhr="0">
          <layer pass="0" class="SvgMarker" locked="0" enabled="1">
            ...
            <prop v="/var/www/smartworld/occitanie_gpkg/img/Motel.svg" k="name"/>
            <prop v="0,0" k="offset"/>
  ...
  <SingleCategoryDiagramRenderer attributeLegend="1" diagramType="Histogram">
    <DiagramCategory backgroundColor="#ffffff" scaleDependency="Area" width="15" lineSizeScale="3x:0,0,0,0,0,0" labelPlacementMethod="XHeight" penColor="#000000" minimumSize="0" penAlpha="255" height="15" backgroundAlpha="255" sizeScale="3x:0,0,0,0,0,0" opacity="1" penWidth="0" rotationOffset="270" lineSizeType="MM" sizeType="MM" minScaleDenominator="0" barWidth="5" scaleBasedVisibility="0" maxScaleDenominator="1e+08" diagramOrientation="Up" enabled="0">
      <fontProperties description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0" style=""/>
      <attribute label="" color="#000000" field=""/>
    </DiagramCategory>
  </SingleCategoryDiagramRenderer>
  <DiagramLayerSettings linePlacementFlags="18" zIndex="0" obstacle="0" placement="0" dist="0" priority="0" showAll="1">
    <properties>
      <Option type="Map">
        <Option value="" type="QString" name="name"/>
        <Option name="properties"/>
