...
<qgis readOnly="0" hasScaleBasedVisibilityFlag="0" version="3.4.7-Madeira" simplifyDrawingTol="1" maxScale="0" minScale="1e+08" simplifyDrawingHints="0" simplifyLocal="1" labelsEnabled="0" simplifyAlgorithm="0" styleCategories="AllStyleCategories" simplifyMaxScale="1">
  <flags>
      ...
      <symbols>
        <symbol clip_to_extent="1" name="0" type="marker" alpha="1" force_rhr="0">
          <layer locked="0" enabled="1" class="SvgMarker" pass="0">
            ...
            <prop k="name" v="/var/www/smartworld/occitanie_gpkg/img/Gare_ferroviaire.svg"/>
            <prop k="offset" v="0,0"/>
  ...
  <SingleCategoryDiagramRenderer diagramType="Histogram" attributeLegend="1">
    <DiagramCategory minimumSize="0" scaleDependency="Area" lineSizeType="MM" maxScaleDenominator="1e+08" backgroundAlpha="255" opacity="1" width="15" barWidth="5" labelPlacementMethod="XHeight" penColor="#000000" sizeType="MM" penAlpha="255" minScaleDenominator="0" penWidth="0" scaleBasedVisibility="0" rotationOffset="270" backgroundColor="#ffffff" lineSizeScale="3x:0,0,0,0,0,0" sizeScale="3x:0,0,0,0,0,0" enabled="0" height="15" diagramOrientation="Up">
      <fontProperties description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0" style=""/>
      <attribute field="" color="#000000" label=""/>
    </DiagramCategory>
  </SingleCategoryDiagramRenderer>
  <DiagramLayerSettings showAll="1" dist="0" priority="0" zIndex="0" placement="0" linePlacementFlags="18" obstacle="0">
    <properties>
      <Option type="Map">
        <Option value="" name="name" type="QString"/>
        <Option name="properties"/>
