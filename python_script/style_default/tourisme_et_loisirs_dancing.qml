...
<qgis minScale="1e+08" maxScale="0" simplifyDrawingHints="0" simplifyMaxScale="1" styleCategories="AllStyleCategories" simplifyAlgorithm="0" simplifyDrawingTol="1" labelsEnabled="0" simplifyLocal="1" readOnly="0" version="3.4.7-Madeira" hasScaleBasedVisibilityFlag="0">
  <flags>
    <Identifiable>1</Identifiable>
    <Removable>1</Removable>
    <Searchable>1</Searchable>
  </flags>
  <renderer-v2 forceraster="0" enableorderby="0" type="pointCluster" toleranceUnitScale="3x:0,0,0,0,0,0" toleranceUnit="MM" tolerance="20">
      ...
      <symbols>
        <symbol name="0" type="marker" alpha="1" force_rhr="0" clip_to_extent="1">
          <layer locked="0" class="SvgMarker" enabled="1" pass="0">
            ...
            <prop k="name" v="/var/www/smartworld/occitanie_gpkg/img/Dancing_hall.svg"/>
            <prop k="offset" v="0,0"/>
  ...
  <SingleCategoryDiagramRenderer diagramType="Histogram" attributeLegend="1">
    <DiagramCategory opacity="1" sizeScale="3x:0,0,0,0,0,0" penWidth="0" scaleBasedVisibility="0" barWidth="5" sizeType="MM" minScaleDenominator="0" penAlpha="255" width="15" backgroundAlpha="255" lineSizeScale="3x:0,0,0,0,0,0" diagramOrientation="Up" height="15" lineSizeType="MM" minimumSize="0" maxScaleDenominator="1e+08" rotationOffset="270" scaleDependency="Area" backgroundColor="#ffffff" enabled="0" labelPlacementMethod="XHeight" penColor="#000000">
