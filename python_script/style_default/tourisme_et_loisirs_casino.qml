...
<qgis readOnly="0" hasScaleBasedVisibilityFlag="0" simplifyMaxScale="1" simplifyDrawingHints="0" simplifyDrawingTol="1" version="3.4.7-Madeira" simplifyAlgorithm="0" labelsEnabled="0" minScale="1e+08" simplifyLocal="1" styleCategories="AllStyleCategories" maxScale="0">
  <flags>
      ...
      <symbols>
        <symbol clip_to_extent="1" name="0" alpha="1" type="marker" force_rhr="0">
          <layer enabled="1" locked="0" pass="0" class="SvgMarker">
            ...
            <prop k="name" v="/var/www/smartworld/occitanie_gpkg/img/Casino.svg"/>
            <prop k="offset" v="0,0"/>
  ...
  <SingleCategoryDiagramRenderer diagramType="Histogram" attributeLegend="1">
    <DiagramCategory enabled="0" backgroundColor="#ffffff" maxScaleDenominator="1e+08" sizeScale="3x:0,0,0,0,0,0" penWidth="0" scaleDependency="Area" barWidth="5" minimumSize="0" penAlpha="255" opacity="1" lineSizeType="MM" width="15" rotationOffset="270" scaleBasedVisibility="0" minScaleDenominator="0" sizeType="MM" backgroundAlpha="255" penColor="#000000" height="15" labelPlacementMethod="XHeight" diagramOrientation="Up" lineSizeScale="3x:0,0,0,0,0,0">
      <fontProperties style="" description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0"/>
      <attribute label="" field="" color="#000000"/>
    </DiagramCategory>
  </SingleCategoryDiagramRenderer>
  <DiagramLayerSettings dist="0" showAll="1" priority="0" linePlacementFlags="18" zIndex="0" placement="0" obstacle="0">
    <properties>
      <Option type="Map">
        <Option name="name" value="" type="QString"/>
        <Option name="properties"/>
