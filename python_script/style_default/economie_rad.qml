...
<qgis simplifyMaxScale="1" readOnly="0" hasScaleBasedVisibilityFlag="0" minScale="1e+08" maxScale="0" simplifyAlgorithm="0" styleCategories="AllStyleCategories" simplifyDrawingHints="0" simplifyLocal="1" version="3.4.7-Madeira" labelsEnabled="0" simplifyDrawingTol="1">
  <flags>
      ...
      <symbols>
        <symbol clip_to_extent="1" force_rhr="0" type="marker" name="0" alpha="1">
          <layer locked="0" class="SvgMarker" enabled="1" pass="0">
            ...
            <prop k="name" v="/var/www/smartworld/occitanie_gpkg/img/rad.svg"/>
            <prop k="offset" v="0,0"/>
  ...
  <SingleCategoryDiagramRenderer diagramType="Histogram" attributeLegend="1">
    <DiagramCategory lineSizeScale="3x:0,0,0,0,0,0" labelPlacementMethod="XHeight" diagramOrientation="Up" width="15" penAlpha="255" backgroundAlpha="255" lineSizeType="MM" backgroundColor="#ffffff" enabled="0" scaleDependency="Area" opacity="1" maxScaleDenominator="1e+08" penColor="#000000" height="15" sizeType="MM" sizeScale="3x:0,0,0,0,0,0" penWidth="0" minScaleDenominator="0" barWidth="5" rotationOffset="270" scaleBasedVisibility="0" minimumSize="0">
      <fontProperties style="" description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0"/>
      <attribute field="" label="" color="#000000"/>
    </DiagramCategory>
  </SingleCategoryDiagramRenderer>
  <DiagramLayerSettings placement="0" priority="0" linePlacementFlags="18" obstacle="0" showAll="1" zIndex="0" dist="0">
    <properties>
      <Option type="Map">
        <Option type="QString" name="name" value=""/>
        <Option name="properties"/>
