...
<qgis simplifyDrawingTol="1" maxScale="0" simplifyMaxScale="1" simplifyDrawingHints="0" version="3.4.7-Madeira" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" minScale="1e+08" labelsEnabled="0" readOnly="0" simplifyAlgorithm="0" styleCategories="AllStyleCategories">
  <flags>
    <Identifiable>1</Identifiable>
    <Removable>1</Removable>
    <Searchable>1</Searchable>
  </flags>
  <renderer-v2 toleranceUnitScale="3x:0,0,0,0,0,0" toleranceUnit="MM" type="pointCluster" enableorderby="0" tolerance="20" forceraster="0">
      ...
      <symbols>
        <symbol force_rhr="0" alpha="1" type="marker" clip_to_extent="1" name="0">
          <layer class="SvgMarker" locked="0" enabled="1" pass="0">
            ...
            <prop v="/var/www/smartworld/occitanie_gpkg/img/aeroports.svg" k="name"/>
            <prop v="0,0" k="offset"/>
    ...
    <symbol force_rhr="0" alpha="1" type="marker" clip_to_extent="1" name="centerSymbol">
      <layer class="SvgMarker" locked="0" enabled="1" pass="0">
        <prop v="0" k="angle"/>
  ...
  <SingleCategoryDiagramRenderer attributeLegend="1" diagramType="Histogram">
    <DiagramCategory sizeScale="3x:0,0,0,0,0,0" penAlpha="255" lineSizeType="MM" backgroundAlpha="255" penColor="#000000" sizeType="MM" minimumSize="0" labelPlacementMethod="XHeight" enabled="0" barWidth="5" diagramOrientation="Up" height="15" minScaleDenominator="0" scaleBasedVisibility="0" opacity="1" maxScaleDenominator="1e+08" scaleDependency="Area" penWidth="0" lineSizeScale="3x:0,0,0,0,0,0" rotationOffset="270" backgroundColor="#ffffff" width="15">
      <fontProperties style="" description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0"/>
      <attribute label="" color="#000000" field=""/>
    </DiagramCategory>
  </SingleCategoryDiagramRenderer>
  <DiagramLayerSettings obstacle="0" dist="0" linePlacementFlags="18" placement="0" priority="0" zIndex="0" showAll="1">
    <properties>
      <Option type="Map">
        <Option type="QString" name="name" value=""/>
        <Option name="properties"/>
