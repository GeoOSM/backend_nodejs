...
<qgis minScale="100000000" readOnly="0" styleCategories="AllStyleCategories" hasScaleBasedVisibilityFlag="0" labelsEnabled="0" simplifyMaxScale="1" maxScale="0" simplifyLocal="1" simplifyDrawingHints="1" version="3.14.1-Pi" simplifyAlgorithm="0" simplifyDrawingTol="1">
  <flags>
    <Identifiable>1</Identifiable>
    <Removable>1</Removable>
    <Searchable>1</Searchable>
  </flags>
  <temporal endExpression="" endField="" durationField="" startExpression="" durationUnit="min" mode="0" enabled="0" startField="" accumulate="0" fixedDuration="0">
    <fixedRange>
      <start></start>
      <end></end>
    </fixedRange>
    ...
    <symbols>
      <symbol alpha="1" force_rhr="0" clip_to_extent="1" type="line" name="0">
        <layer class="SimpleLine" pass="0" locked="0" enabled="1">
          ...
          <prop v="253,249,12,255" k="line_color"/>
  ...
  <SingleCategoryDiagramRenderer attributeLegend="1" diagramType="Histogram">
    <DiagramCategory minScaleDenominator="0" barWidth="5" showAxis="0" maxScaleDenominator="1e+08" spacing="0" labelPlacementMethod="XHeight" scaleDependency="Area" sizeType="MM" spacingUnitScale="3x:0,0,0,0,0,0" opacity="1" penAlpha="255" direction="1" rotationOffset="270" spacingUnit="MM" height="15" scaleBasedVisibility="0" enabled="0" lineSizeType="MM" diagramOrientation="Up" penWidth="0" width="15" minimumSize="0" backgroundAlpha="255" penColor="#000000" sizeScale="3x:0,0,0,0,0,0" lineSizeScale="3x:0,0,0,0,0,0" backgroundColor="#ffffff">
